...
final List<Centerid> centerNames = [
  Centerid(
    ...
    image: Image.asset('images/ce2.jpg'),
  ),
  Centerid(
    ...
    image: Image.asset('images/ce9.png', width: 70.0, height: 120.0),
  ),
  Centerid(
    ...
    image: Image.asset('images/ce10.jpg', width: 80.0),
  ),
  Centerid(
    address: 'Gulu Center',
    name: 'Gulu_FoodBank',
    ...
    image: Image.asset('images/ce4.jpg', width: 80.0),
  ),
  Centerid(
    ...
    image: Image.asset('images/ce6.png', width: 80.0),
  ),
];
