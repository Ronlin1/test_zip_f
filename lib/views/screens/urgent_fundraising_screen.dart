...
import 'package:efunding/controller/urgent_fundraising_controller.dart';
...
class UrgentFundraisingScreen extends StatelessWidget {
  UrgentFundraisingScreen({Key? key}) : super(key: key);
  final _controller = Get.put(UrgentFundraisingController());
