...
import 'package:efunding/controller/all_campaign_controller.dart';
...
import 'package:efunding/widgets/others/filter_campaign_widget.dart';

class AllCampaignScreen extends StatelessWidget {
  AllCampaignScreen({Key? key}) : super(key: key);
  final _controller = Get.put(AllCampaignController());
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return CategoriesChildContainerWidget(
          ...
          totalDonatedPercentage: Strings.shareNutritiousFoodDonatedPercentage,
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          Strings.filterCampaign,
                          textAlign: TextAlign.left,
                          style: TextStyle(
                              color: CustomColor.whiteColor,
                              fontSize: Dimensions.smallTextSize + 5,
                              fontWeight: FontWeight.w700),
                        ),
                        Divider(
                          color: CustomColor.whiteColor.withOpacity(0.5),
                        ),
                        const FilterCampaignWidget(),
                        addVerticalSpace(40.h),
                        Text(
