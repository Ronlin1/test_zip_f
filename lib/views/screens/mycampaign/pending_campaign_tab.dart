...
class PendingCampaignTab extends StatelessWidget {
  const PendingCampaignTab({Key? key}) : super(key: key);
  ...
  Widget _bodyWidget(BuildContext context) {
    return _pendingContainerWidget(context);
  }

  _pendingContainerWidget(BuildContext context) {
